...
export const cellNodeToReactAs = (context: RenderContext, tag: TableCellTag): React.ReactNode => {
...
export const cellNodeToReact = (context: RenderContext): React.ReactNode => cellNodeToReactAs(context, 'td');
